...
model = dict(
    ...
    backbone=dict(
        ...
        norm_eval=True,
        init_cfg=dict(type='Pretrained', checkpoint='pretrained_models/cascade_mask_rcnn_r18_fpn_coco-mstrain_3x_20e_nuim_bbox_mAP_0.5110_segm_mAP_0.4070.pth'),
        style='pytorch'
    ),
    neck=dict(
        type='FPN',
    ...
    bbox_head=dict(
        ...
        loss_dir=dict(
            type='CrossEntropyLoss', use_sigmoid=True, loss_weight=0.8)),
    multi_scale_id=[0],
    n_voxels=[[200, 200, 4]],
...
load_from = False#'pretrained_models/fastbev_m0_r18_s256x704_v200x200x4_c192_d2_f4/epoch_20.pth'
resume_from = False
workflow = [('train', 1)]
