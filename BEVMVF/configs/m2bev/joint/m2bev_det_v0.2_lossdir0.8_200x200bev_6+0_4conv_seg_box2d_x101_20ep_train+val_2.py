# -*- coding: utf-8 -*-
load_from = 'pretrained_models/m2bev_det_v0.2_lossdir0.8_200x200bev_6+0_4conv_seg_box2d_x101_20ep_train+val/htc_x101_64x4d_fpn_dconv_c3-c5_coco-20e_16x1_20e_nuim_20201008_211222-0b16ac4b.pth'
model = dict(
    type='M2BevNet_2',
    backbone=dict(
        type='ResNet',
...
data_root_test = 'data/nuscenes_test/'
...
#         ann_file=data_root + 'nuscenes_infos_val.pkl',
        ...
        ann_file=data_root_test + 'nuscenes_infos_test.pkl',
        pipeline=test_pipeline,
        classes=class_names,
        modality=input_modality,
        test_mode=True,
